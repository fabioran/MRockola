#############################################################################
# Makefile for building: MRockola
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  MRockola.pro
# Template: app
# Command: /bin/qmake-qt5 -o Makefile MRockola.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_QML_DEBUG -DQT_QUICK_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_QML_LIB -DQT_NETWORK_LIB -DQT_SQL_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -g -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/lib64 -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtQuick -isystem /usr/include/qt5/QtWidgets -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtQml -isystem /usr/include/qt5/QtNetwork -isystem /usr/include/qt5/QtSql -isystem /usr/include/qt5/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib64/qt5/mkspecs/linux-g++
QMAKE         = /bin/qmake-qt5
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MRockola1.0.0
DISTDIR = /home/vmadmin/BUILDROOT/MRockola-master/.tmp/MRockola1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L/usr/lib64/ -lvlc -lQt5Quick -lQt5Widgets -lQt5Gui -lQt5Qml -lQt5Network -lQt5Sql -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
SOURCES       = main.cpp \
		...
		sources/keyboard.cpp qrc_qml.cpp \
		qrc_images.cpp \
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		MRockola.pro sources/constants.h \
		sources/database.h \
		sources/mediaitem.h \
		sources/mediaplayer.h \
		sources/settings.h \
		sources/keyboard.h main.cpp \
		sources/constants.cpp \
		sources/database.cpp \
		sources/mediaitem.cpp \
		sources/mediaplayer.cpp \
...
Makefile: MRockola.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile MRockola.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qml.qrc images.qrc translations.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib64/qt5/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents sources/constants.h sources/database.h sources/mediaitem.h sources/mediaplayer.h sources/settings.h sources/keyboard.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp sources/constants.cpp sources/database.cpp sources/mediaitem.cpp sources/mediaplayer.cpp sources/settings.cpp sources/keyboard.cpp $(DISTDIR)/
	$(COPY_FILE) --parents languages/mrockola_es.ts $(DISTDIR)/
...
compiler_rcc_make_all: qrc_qml.cpp qrc_images.cpp qrc_translations.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_qml.cpp qrc_images.cpp qrc_translations.cpp
qrc_qml.cpp: qml.qrc \
		/usr/lib64/qt5/bin/rcc \
		components/Folderui.qml \
		components/ControlBar.qml \
		components/CoverDetail.qml \
		components/MRSetup.qml \
		components/Plist.qml \
		components/Helpui.qml \
		components/Finder.qml \
		components/DisplayBar.qml \
		components/LookAndFeelui.qml \
		components/Search.qml \
		components/Progressbar.qml \
		components/ButtonsAction.qml \
		components/Aboutui.qml \
		components/Background.qml \
		components/Cover.qml \
		components/Keyboardui.qml \
		main/MRockola.qml \
		main/CenterDialog.qml
	/usr/lib64/qt5/bin/rcc -name qml qml.qrc -o qrc_qml.cpp

qrc_images.cpp: images.qrc \
		/usr/lib64/qt5/bin/rcc \
		resources/images/mghik.png \
		resources/images/arrowup.png \
		resources/images/playlist_cover1.png \
		resources/images/interface.png \
		resources/images/folder.png \
		resources/images/folder.png \
		resources/images/mrockola_icono_64x64.png \
		resources/images/about.png \
		resources/images/mrockola_splash.png \
		resources/images/background.jpg \
		resources/images/arrowleft.png \
		resources/images/audioVideo.png \
		resources/images/arrowright.png \
		resources/images/black.png \
		resources/images/help.png \
		resources/images/defaultCover.png \
...
compiler_moc_header_make_all: moc_database.cpp moc_mediaplayer.cpp moc_settings.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_database.cpp moc_mediaplayer.cpp moc_settings.cpp
moc_database.cpp: sources/constants.h \
		sources/mediaitem.h \
		sources/database.h \
		moc_predefs.h \
		/usr/lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/vmadmin/BUILDROOT/MRockola-master -I/usr/lib64 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include sources/database.h -o moc_database.cpp

moc_mediaplayer.cpp: sources/mediaplayer.h \
		moc_predefs.h \
		/usr/lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/vmadmin/BUILDROOT/MRockola-master -I/usr/lib64 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include sources/mediaplayer.h -o moc_mediaplayer.cpp

moc_settings.cpp: sources/keyboard.h \
		sources/settings.h \
		moc_predefs.h \
		/usr/lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/vmadmin/BUILDROOT/MRockola-master -I/usr/lib64 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include sources/settings.h -o moc_settings.cpp
...
main.o: main.cpp sources/database.h \
		sources/constants.h \
		sources/mediaitem.h \
		sources/mediaplayer.h \
		sources/settings.h \
...
constants.o: sources/constants.cpp sources/constants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o constants.o sources/constants.cpp

database.o: sources/database.cpp sources/database.h \
		sources/constants.h \
		sources/mediaitem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o database.o sources/database.cpp

mediaitem.o: sources/mediaitem.cpp sources/mediaitem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mediaitem.o sources/mediaitem.cpp

mediaplayer.o: sources/mediaplayer.cpp sources/mediaplayer.h \
		sources/constants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mediaplayer.o sources/mediaplayer.cpp

settings.o: sources/settings.cpp sources/settings.h \
		sources/keyboard.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o settings.o sources/settings.cpp

keyboard.o: sources/keyboard.cpp sources/keyboard.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o keyboard.o sources/keyboard.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/MRockola/bin || mkdir -p $(INSTALL_ROOT)/opt/MRockola/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/MRockola/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/MRockola/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/MRockola/bin/ 
